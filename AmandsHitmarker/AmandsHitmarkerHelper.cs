...
public class AmandsHitmarkerHelper
{
    ...
    {
        return (string)LocalizedMethod.Invoke(null, [id, @case]);
    }
    public static bool IsBoss(WildSpawnType role)
    {
        return (bool)IsBossMethod.Invoke(null, [role]);
    }
    public static bool IsFollower(WildSpawnType role)
    {
        return (bool)IsFollowerMethod.Invoke(null, [role]);
    }
    public static bool CountAsBossForStatistics(WildSpawnType role)
    {
        return (bool)CountAsBossForStatisticsMethod.Invoke(null, [role]);
    }
    public static string GetScavRoleKey(WildSpawnType role)
    {
        return (string)GetScavRoleKeyMethod.Invoke(null, [role]);
    }
    public static string Transliterate(string text)
    {
        return (string)TransliterateMethod.Invoke(null, [text]);
    }
    public static bool UsesFSR2Upscaler()
    {
        return UsesFSR2UpscalerMethodFound && 
               (bool)UsesFSR2UpscalerMethod.Invoke(null, []);
    }
}